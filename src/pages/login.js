...
import kidland from '../assets/kidland2.png'
...
<div className="flex h-screen">
      ...
      <div className="w-1/2 bg-gray-200 flex items-center justify-center">
        ...
        <img src={kidland} alt="Theme Image" className="object-cover w-full h-full" />
